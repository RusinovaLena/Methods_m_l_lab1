...
if(v == 1):
    ...
    counts_min, counts_max = m.get_normalization_main_max(x)
    ...
    m.standardization(x, counts_mu, counts_sigma)
    counts_min_test, counts_max_test = m.get_normalization_main_max(x)
    ...
    print("precision: ", m.precision(x_test, prm, y_test))
